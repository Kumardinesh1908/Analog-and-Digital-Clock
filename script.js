...
function setClockTime() {
    ...
    let hourDeg = (hh * 30) + (mm * 0.5); // every 60min, angle will 360/12 =  30Deg and  30/60 = 0.5/Deg per min
    let minuteDeg = (mm * 6) + (ss * 0.1); // every 60min, angle will 360/60 = 6Deg then 6/60 = 0.1 per sec 
    let secondDeg = ss * 6;  // every 60sec, angle will 360/60 = 6Deg 
